...
# research.harness.realistic_fills). Flat 2% taker on notional applies to EVERY
# taker fill; the per-token curve piece is tiny near ATM but included for honesty.
